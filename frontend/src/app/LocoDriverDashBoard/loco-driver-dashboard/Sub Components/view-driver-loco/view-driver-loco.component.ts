...
@Component({
  selector: 'app-view-driver-loco',
  templateUrl: './view-driver-loco.component.html',
  styleUrls: ['./view-driver-loco.component.css'],
})
export class ViewDriverLocoComponent implements OnInit {
  progresValue: number;
  rangeArray: number[];
  ...
  viewLoco(id: string) {
    this.router.navigate(['/locoDriverDashBoard/viewLocoDriverProfile', id]);
  }
