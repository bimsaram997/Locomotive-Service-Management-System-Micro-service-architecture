    ...
    this.locomotiveService
      ...
      .subscribe((res) => {
        if (res !== undefined) {
          ...
          this.editLocoGroup.controls['statusReason'].setValue(
            res[0].statusReason
          );
          this.statusLoco = res[0].locoStatus;
          this.historyLocoGroup.controls['locoCatId'].setValue(
            res[0].locoCatId
          );
          this.historyLocoGroup.controls['locoNumber'].setValue(
            res[0].locoNumber
          );
          this.historyLocoGroup.controls['locoPower'].setValue(
            res[0].locoPower
          );
          this.historyLocoGroup.controls['locoMileage'].setValue(
            res[0].locoMileage
          );
          this.historyLocoGroup.controls['locoDate'].setValue(res[0].locoDate);
          this.historyLocoGroup.controls['locoAvailability'].setValue(
