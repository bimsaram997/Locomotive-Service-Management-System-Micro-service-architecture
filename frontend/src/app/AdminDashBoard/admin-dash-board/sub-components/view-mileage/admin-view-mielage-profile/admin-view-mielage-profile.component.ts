...
@Component({
  selector: 'app-admin-view-mielage-profile',
  templateUrl: './admin-view-mielage-profile.component.html',
  styleUrls: ['./admin-view-mielage-profile.component.css'],
})
export class AdminViewMielageProfileComponent implements OnInit {
