...
export class AccessService {
  ...
  public getOneUser(id: string): Observable<any> {
    return this.http.get<any>(this.myUrl + `accessRoute/getOneUser/${id}`);
  }
  ...
  validPasswordToken(body): Observable<any> {
    return this.http.post(
      this.myUrl + `accessRoute/valid-password-token`,
      body
    );
  }
  ...
  public deleteUser(id: string): Observable<any> {
    return this.http.delete(this.myUrl + 'accessRoute/deleteUser', {
      headers: { id },
    });
  }
  ...
  public login(email: string, password: string): Observable<any> {
    return this.http
      .get<any>(this.myUrl + 'accessRoute/loginUser', {
  ...
  getOneMan(managerName): Observable<any> {
    return this.http.get<any>(
      this.myUrl + `accessRoute/getOneMan/${managerName}`
    );
  }

  public getUserInfo(object): Observable<any> {
    return this.http.get(this.myUrl + `accessRoute/getUserInfo/`, {
      params: object,
    });
  }
